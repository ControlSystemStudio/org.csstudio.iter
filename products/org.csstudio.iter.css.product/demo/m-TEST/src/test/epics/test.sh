#!/bin/bash
#+======================================================================
# $HeadURL: https://svnpub.iter.org/codac/iter/codac/dev/units/m-codac-unit-api/trunk/src/main/resources/test.sh $
# $Id: test.sh 54863 2015-02-20 21:39:47Z zagara $
#
