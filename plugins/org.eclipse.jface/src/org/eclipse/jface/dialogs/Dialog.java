...
public abstract class Dialog extends Window {
    ...
    /**
     * Constructs a new dummy shell which can be used as a parent to dialogs that are to be shown on top of the full
     * screen workbench window. This shell needs to be disposed of when no longer needed.
     *
