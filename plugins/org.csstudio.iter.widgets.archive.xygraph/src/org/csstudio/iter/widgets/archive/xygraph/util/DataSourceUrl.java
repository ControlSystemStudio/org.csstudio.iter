 ...
 ******************************************************************************/
package org.csstudio.iter.widgets.archive.xygraph.util;
...
public class DataSourceUrl {
    ...
    public static List<String> getURLs() {
        ...
        String urlAll = "";
        if (prefs != null) {
            urlAll = prefs.getString(QUALIFIER_DATABROWSER2_ID, QUALIFIER_DATABROWSER2_KEY_URL, DEFAULT_URL_DATASOURCE,
                    null);
        }
        if (urlAll != null) {
