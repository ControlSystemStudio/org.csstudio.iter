...
public class ArchiveXYGraphModel extends XYGraphModel {
    ...
    protected void configureProperties() {
        ...
        addProperty(new IntegerProperty(PROP_TIME_SPAN, "Time span", WidgetPropertyCategory.Behavior, DEFAULT_TIME_SPAN,
                0, Integer.MAX_VALUE));
        addProperty(
                new BooleanProperty(PROP_PLOT_DATA_SOURCE, "Plot Data Source", WidgetPropertyCategory.Behavior, true));
