...
public class DbdParserUnitTest {
    ...
    /**
     * Test that the {@link String} printed from ANTLR {@link Tree} generated from testRecord.dbd is equal to the
     * content of testRecordTree.txt (expected result). Test that the {@link Template} generated from ANTLR {@link Tree}
     * contains the right number of values. Test that the toString method of {@link Template} returns a {@link String}
     * equal to the content of testRecordTemplate.txt (expected result).
     */
    @Test
    public void testParser() {
        try {
            String dbFile = DbdUtil.readFile(UnitTestUtils.getTestResource("testRecord.dbd"));
            ...
            String testRecordTree = UnitTestUtils.readFile(UnitTestUtils.getTestResource("testRecordTree.txt"));
            ...
            String testRecordTemplate = UnitTestUtils.readFile(UnitTestUtils.getTestResource("testRecordTemplate.txt"));
