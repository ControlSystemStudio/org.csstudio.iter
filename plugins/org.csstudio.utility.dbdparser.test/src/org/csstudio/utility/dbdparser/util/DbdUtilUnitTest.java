...
/**
 * Test {@link DbdUtil}. readFile: read a {@link File} and return a {@link String} with comments & C declaration
 * replaced by an empty line. generateTemplate: return a non-null {@link Template} initialized from base.dbd file in the
 * specified directory. Test compatibility with EPICS 3.15.
 *
...
public class DbdUtilUnitTest {
    ...
    /**
     * Test that the {@link String} read from testRecord.dbd is equal to the content of testRecordCleaned.dbd (expected
     * result).
     */
    @Test
    public void testReadFile() {
        try {
            ...
            String testDBD = DbdUtil.readFile(UnitTestUtils.getTestResource("testRecord.dbd"));
            String testDBDCleaned = UnitTestUtils.readFile(UnitTestUtils.getTestResource("testRecordCleaned.dbd"));
    ...
    /**
     * Test that {@link Template} generated from resource/test/base.dbd is not null and not empty.
     */
    @Test
    ...
    /**
     * Test that the {@link DbdParser} is compatible with EPICS 3.15 Based on EPICS Base Release 3.15.0.2
