...
public class Device {
    ...
    public Device(String recordType, String linkType, String dsetName, String choiceString) {
    ...
    public String toString() {
        return "Device [recordType=" + recordType + ", linkType=" + linkType + ", dsetName=" + dsetName
