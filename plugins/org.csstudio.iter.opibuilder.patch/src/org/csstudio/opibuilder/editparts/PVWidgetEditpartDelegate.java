...
//                updateWritable(widgetModel, pv);
    ...
    private static final Logger log = Logger.getLogger("PVWidgetEditpartDelegate");
    private static boolean opiBeastAlarmsEnabled = BeastPreferencesHelper.isOpiBeastAlarmsEnabled();
    ...
    public void registerBasePropertyChangeHandlers() {
        ...
        class BeastListenerPVNameChangeHandler implements IWidgetPropertyChangeHandler{
            @Override
