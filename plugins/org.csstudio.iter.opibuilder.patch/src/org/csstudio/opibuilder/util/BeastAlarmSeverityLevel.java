...
/** A severity level as defined in {@code org.csstudio.alarm.beast.SeverityLevel}.
 *  <p>
 *  Defined as an enum with known instances OK, MINOR..
 *  Recreated here so that widgets will be able to differentiate between Alarm and
 *  AcknowledgedAlarm states as received from BEAST.
 *
 *  @author Boris Versic
 */
public enum BeastAlarmSeverityLevel {
     ...
     *  @param active {@code true} for active alarm severity,
    ...
    /**
     * Get only the {@link AlarmSeverity} of this BeastAlarmSeverityLevel (without the Ack/Unack differentiation).
     * @return This severity's AlarmSeverity
     */
    ...
    /**
     * Is the Latched Alarm Active (not OK, not Acknowledged) ?
     * @return {@code true} if severity indicates an active alarm,
     *         {@code false} for acknowledged or OK state
     */
    ...
    /**
     * Get the name of the severity level to be used in the UI.
    ...
    /**
     * Parse the severity level from a string.
