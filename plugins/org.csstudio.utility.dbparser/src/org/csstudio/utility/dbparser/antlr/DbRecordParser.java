...
public class DbRecordParser extends Parser {
    public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ALIAS", "COMMENT",
            "ESC_SEQ", "EXPONENT", "FIELD", "FLOAT", "HEX_DIGIT", "ID", "INFO", "INT", "NonQuotedString", "OCTAL_ESC",
            "RECORD", "RECORD_BODY", "RECORD_INSTANCE", "String", "TYPE", "UNICODE_ESC", "VALUE", "WHITESPACE", "'('",
            "')'", "','", "'{'", "'}'" };
    ...
    public String[] getTokenNames() {
        return DbRecordParser.tokenNames;
    }
                ...
                // 31:36: -> ^( 'record_instance' record_head record_block )
                {
                    // DbRecord.g:31:39: ^( 'record_instance' record_head record_block )
                    {
                        ...
                        root_1 = (Object) adaptor
                                .becomeRoot((Object) adaptor.create(RECORD_INSTANCE, "RECORD_INSTANCE"), root_1);
        ...
        try {
            ...
            // DbRecord.g:35:16: '{' ( record_body )* '}'
            {
                ...
                // 35:38: -> ^( 'record_body' ( record_body )* )
                {
                    ...
                    {
                        Object root_1 = (Object) adaptor.nil();
                        root_1 = (Object) adaptor.becomeRoot((Object) adaptor.create(RECORD_BODY, "RECORD_BODY"),
                                root_1);
        ...
        try {
            ...
            // DbRecord.g:41:8: 'info' '(' key_value ')'
            {
                ...
                // 41:33: -> ^( INFO key_value )
                {
                    ...
                    {
                        Object root_1 = (Object) adaptor.nil();
                        root_1 = (Object) adaptor.becomeRoot((Object) adaptor.create(INFO, "INFO"), root_1);
